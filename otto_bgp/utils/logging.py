...
class BGPToolkitLogger:
    ...
    def log_bgpq3_execution(self, as_number: int, success: bool, duration: float = None):
    ...
    def log_batch_summary(self, operation: str, total: int, successful: int, duration: float):
...
def setup_logging(config_manager=None, 
                 ...
                 include_modules: bool = True) -> Dict[str, logging.Handler]:
    """
    ...
    logging_config = config_manager.logging if hasattr(config_manager, 'logging') else None
    ...
    console_formatter = BGPToolkitFormatter(
        ...
        include_module=include_modules
    )
...
def _is_running_as_service() -> bool:
    ...
    try:
        ...
        return (
            ...
            os.getenv('JOURNAL_STREAM') is not None
        )
