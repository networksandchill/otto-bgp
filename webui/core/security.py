...
def get_jwt_secret() -> str:
    ...
    try:
        ...
        logging.getLogger("otto.webui").error(f"Failed to read JWT secret: {e}")

    if OTTO_DEV_MODE:
        logging.getLogger("otto.webui").warning("Using development JWT secret - DO NOT USE IN PRODUCTION")
